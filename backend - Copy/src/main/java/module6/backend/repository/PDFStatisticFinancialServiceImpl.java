...
@Service
public class PDFStatisticFinancialServiceImpl {
    ...
    public ByteArrayInputStream export(String[] data) throws IOException {
        ...
        try {
            ...
            document.open();
            Font f = new Font(BaseFont.createFont("\"C:\\Users\\PC\\Downloads\\vuArial.ttf\"", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
            ...
            Paragraph para = new Paragraph("Thống kê tài chính", f);
            para.setAlignment(Element.ALIGN_CENTER);
            document.add(para);
            document.add(Chunk.NEWLINE);

            PdfPTable table = new PdfPTable(5);
            Stream.of("Bán hàng", "Nhập hàng", "Hủy hàng", "Trả hàng", "Lương nhân viên").forEach(headerTitle -> {
